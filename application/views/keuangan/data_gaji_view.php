<div class="x_title">
	<div class="row">
		<div class="col-md-12">
			<h1 style="text-align: right;">Data Gaji</h1><br>
		</div>
	</div>

	
<div class="row">
			<form method="post" action="<?= base_url('Laporan/data_gaji_keuangan') ?>"">
...
<div class="card">
	...
	<td align="center">
						<a onclick="return confirm('Apakah anda yakin?')" class="btn btn-success" href="<?= base_url('Laporan/konfirmasi_gaji/') ?><?= $g->id_gaji ?>" data-toggle="tooltip" title="Konfirmasi Diterima"><i class="fa fa-lg fa-check"></i></a>
						<a href="<?= base_url('Cetak_pdf/cetak/'.$g->id_gaji)  ?>" class="btn btn-success" data-toggle="tooltip" title="Cetak gaji"><i class="fa fa-lg fa-print"></i></a>
