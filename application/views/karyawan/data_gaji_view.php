...
<div class="x_title">
	...
	<!-- <div class="row">
			<form method="post" action="<?= base_url('Laporan/data_gaji_karyawan') ?>"">
...
<div class="card">
	...
	<td align="center">
						...
						<a href="<?= base_url('Cetak_pdf/cetak_karyawan/'.$g->id_gaji)  ?>" class="btn btn-success" data-toggle="tooltip" title="Cetak gaji"><i class="fa fa-lg fa-print"></i></a>
